  ...
  return (
    <footer className="py-6 relative overflow-hidden bg-planety-gray-50">
      <div className="container px-4 mx-auto">
        {/* Newsletter signup */}
        <div className="text-center mb-6 pb-6 border-b border-planety-gray-200">
          ...
          <div className="flex max-w-sm mx-auto gap-2">
            <input 
              ...
              className="flex-1 px-3 py-2 text-sm border border-planety-gray-200 rounded-lg focus:outline-none focus:border-planety-indigo"
            />
            <button className="px-4 py-2 bg-planety-indigo text-white rounded-lg text-sm hover:bg-planety-navy transition-colors">
